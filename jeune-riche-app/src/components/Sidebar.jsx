...
import { Shirt, Smartphone, Footprints, ChevronRight, Laptop, Gamepad2, X } from 'lucide-react';
...
const Sidebar = ({ isOpen, onClose, onCategorySelect }) => {
  ...
  return (
    <>
      {/* 1. OVERLAY : Fond sombre pour fermer le menu en cliquant à l'extérieur */}
      {isOpen && (
        <div 
      ...
      {/* 2. SIDEBAR : Le panneau coulissant */}
      <div className={`fixed inset-y-0 left-0 z-[70] w-80 bg-white shadow-2xl transform ${
        ...
        <div className="p-6 border-b flex items-center justify-between">
          <h2 className="text-xl font-black text-gray-900 tracking-tight">CATALOGUE</h2>
          <button 
            onClick={onClose} 
        ...
        {/* Liste des catégories avec scroll si nécessaire */}
        ...
        {/* Pied du menu : Infos utiles */}
        <div className="absolute bottom-0 w-full p-6 border-t bg-gray-50 text-[10px] text-gray-400 font-medium uppercase tracking-widest text-center">
          Jeune Riche Store - Abidjan
        </div>
      </div>
    </>
  );
